...
import static com.github.castorm.kafka.connect.http.response.BWCKvHttpResponseParserTest.Fixture.record;
import static com.github.castorm.kafka.connect.http.response.BWCKvHttpResponseParserTest.Fixture.response;
import static com.github.castorm.kafka.connect.http.response.BWCKvHttpResponseParserTest.Fixture.sourceRecord;
...
class BWCKvHttpResponseParserTest {

    BWCKvHttpResponseParser parser;

    @Mock
    BWCKvHttpResponseParserConfig config;
    ...
    @BeforeEach
    void setUp() {
        parser = new BWCKvHttpResponseParser(__ -> config);
