...
class BWCKvHttpResponseParserConfigTest {
    ...
    void whenDelegate_thenInitialized() {
        assertThat(config(ImmutableMap.of("http.response.record.parser", TestResponseParser.class.getName()))
                        .getRecordParser())
    ...
    private static BWCKvHttpResponseParserConfig config(Map<String, Object> settings) {
        ...
        return new BWCKvHttpResponseParserConfig(defaultSettings);
    }
}
