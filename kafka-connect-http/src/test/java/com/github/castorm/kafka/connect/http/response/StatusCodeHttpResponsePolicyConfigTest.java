...
class StatusCodeHttpResponsePolicyConfigTest {
    ...
    void whenNoDelegate_thenDefault() {
        assertThat(config(emptyMap()).getProcessCodes())
    ...
    void whenDelegate_thenInitialized() {
        assertThat(config(ImmutableMap.of("http.response.policy.codes.process", "200..201"))
                        .getProcessCodes())
    ...
    void whenNoPolicy_thenDefault() {
        assertThat(config(emptyMap()).getSkipCodes())
                .containsExactlyInAnyOrder(
    ...
    void whenPolicy_thenInitialized() {
        assertThat(config(ImmutableMap.of("http.response.policy.codes.skip", "300..301"))
                        .getSkipCodes())
                .containsExactlyInAnyOrder(300, 301);
    }
