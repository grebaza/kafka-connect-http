...
@Getter
public class BWCKvHttpResponseParserConfig extends AbstractConfig {
    ...
    BWCKvHttpResponseParserConfig(Map<String, ?> originals) {
    ...
    public static ConfigDef config() {
        return new ConfigDef()
                .define(
                        RECORD_PARSER_CLASS,
                        CLASS,
                        JacksonKvRecordHttpResponseParser.class,
                        LOW,
