...
public class TemplateHttpRequestFactory implements HttpRequestFactory {
    ...
    public HttpRequest createRequest(RequestInput request) {
        return HttpRequest.builder()
                ...
                .url(urlTpl.apply(request))
                .headers(breakDownHeaders(headersTpl.apply(request)))
                .queryParams(breakDownQueryParams(queryParamsTpl.apply(request)))
                .body(bodyTpl.apply(request).getBytes())
                .build();
    }
}
